...
|camel.name|play-camel|Name for the CamelContext object|Optional|
{background:#eee}.|broker.name|play-activemq|Name for the ActiveMQ Broker|Optional|
|broker.connector|tcp://localhost:61616|host:port that will be exposed by the ActiveMQ Connector|Optional|
